...
<form action="" method="post">
	<ul>
		<li>
			...
			<input type="text" name="hardware_category" id="hardware_category" required>
		</li>
		...
		<li>
			...
			<input type="text" name="hardware_memory" id="hardware_memory" required>
		</li>

		<li>
			<label for="hardware_storage">Storage Capacity : </label>
			<input type="text" name="hardware_storage" id="hardware_storage" required>
		</li>

		<li>
			<label for="hardware_description">Description : </label>
			<input type="text" name="hardware_description" id="hardware_cdescription" required>
		</li>
		...
		<li>
			...
			<input type="text" name="hardware_image" id="hardware_image" required>
		</li>
